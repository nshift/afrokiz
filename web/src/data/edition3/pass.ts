...
export const defaultPasses: { [key: string]: Pass } = {
  ...
  sametPass: {
    ...
    name: 'Samet Getaway Pass',
    isSoldOut: false,
    price: { USD: 30000, EUR: 32000, THB: 1200000 },
    doorPrice: { USD: 60000, EUR: 56800, THB: 2000000 },
    includes: [
  ...
  partyPass: {
    ...
    name: 'Party Pass',
    isSoldOut: false,
    price: { USD: 12000, EUR: 11000, THB: 400000 },
  ...
  friNight: {
    ...
    isSoldOut: false,
    price: { USD: 5000, EUR: 4500, THB: 169000 },
  ...
  fri: {
    ...
    name: 'Friday Pass',
    isSoldOut: false,
    price: { USD: 8000, EUR: 7500, THB: 270000 },
  ...
  sat: {
    ...
    name: 'Saturday Pass',
    isSoldOut: false,
    price: { USD: 9000, EUR: 8500, THB: 300000 },
