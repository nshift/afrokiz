...
export const updateTicketOptions = async (event: APIGatewayEvent, context: Context): Promise<APIGatewayProxyResult> => {
  let request: Request
  try {
  ...
  try {
    ...
    await merchAdministration.updateTicketOptions(request.eventId, request.ticketOptions)
