...
export const addTicketOptions = async (event: APIGatewayEvent, context: Context): Promise<APIGatewayProxyResult> => {
  let request: Request
  try {
  ...
  try {
    ...
    await merchAdministration.addTicketOptions(request.eventId, request.ticketOptions)
