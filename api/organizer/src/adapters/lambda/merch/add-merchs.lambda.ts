...
export const addMerchs = async (event: APIGatewayEvent, context: Context): Promise<APIGatewayProxyResult> => {
  let request: Request
  try {
  ...
  try {
    ...
    await merchAdministration.addMerchs(request.eventId, request.merchs)
